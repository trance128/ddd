...
class _$ValueFailureTearOff {
  ...
  Multiline<T> multiline<T>({@required T failuedValue}) {
    return Multiline<T>(
      failuedValue: failuedValue,
    );
  }
...
mixin _$ValueFailure<T> {
  ...
  Result when<Result extends Object>({
    ...
    @required Result multiline(T failuedValue),
  ...
  Result maybeWhen<Result extends Object>({
    ...
    Result multiline(T failuedValue),
...
class _$MultilineCopyWithImpl<T, $Res>
  ...
  @override
  $Res call({
    Object failuedValue = freezed,
  }) {
    return _then(Multiline<T>(
      failuedValue:
          failuedValue == freezed ? _value.failuedValue : failuedValue as T,
    ));
  }
}

class _$Multiline<T> with DiagnosticableTreeMixin implements Multiline<T> {
  const _$Multiline({@required this.failuedValue})
      : assert(failuedValue != null);

  @override
  final T failuedValue;

  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ValueFailure<$T>.multiline(failuedValue: $failuedValue)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('failuedValue', failuedValue));
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is Multiline<T> &&
            (identical(other.failuedValue, failuedValue) ||
                const DeepCollectionEquality()
                    .equals(other.failuedValue, failuedValue)));
  }

  @override
  int get hashCode =>
      runtimeType.hashCode ^ const DeepCollectionEquality().hash(failuedValue);
...
abstract class Multiline<T> implements ValueFailure<T> {
  const factory Multiline({@required T failuedValue}) = _$Multiline<T>;
